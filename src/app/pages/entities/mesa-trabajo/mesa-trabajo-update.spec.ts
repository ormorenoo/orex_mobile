...
describe('MesaTrabajoUpdatePage', () => {
  let component: MesaTrabajoUpdatePage;
  let fixture: ComponentFixture<MesaTrabajoUpdatePage>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [MesaTrabajoUpdatePage],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MesaTrabajoUpdatePage);
